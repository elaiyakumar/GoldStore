...
namespace GoldStore.Core.Configuration
{
    /// <summary>
    /// Represents a GoldStoreConfig
    /// </summary>
    public partial class GoldStoreConfig : IConfigurationSectionHandler
    {
        /// <summary>
        ...
        {
            var config = new GoldStoreConfig();
            ...
            var supportPreviousGoldStorecommerceVersionsNode = section.SelectSingleNode("SupportPreviousGoldStorecommerceVersions");
            config.SupportPreviousGoldStorecommerceVersions = GetBool(supportPreviousGoldStorecommerceVersionsNode, "Enabled");
        ...
        /// <summary>
        /// Indicates whether we should support previous GoldStore Commerce versions (it can slightly improve performance)
        /// </summary>
        public bool SupportPreviousGoldStorecommerceVersions { get; private set; }
        ...
        /// <summary>
        /// A list of plugins ignored during GoldStoreCommerce installation
        /// </summary>
