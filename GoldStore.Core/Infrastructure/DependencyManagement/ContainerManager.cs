...
namespace GoldStore.Core.Infrastructure.DependencyManagement
{
    /// <summary>
    /// Container manager
    /// </summary>
            ...
            foreach (var constructor in constructors)
            {
                try
                {
                    ...
                    foreach (var parameter in parameters)
                    {
                        ...
                        if (service == null) throw new GoldStoreException("Unknown dependency");
                        parameterInstances.Add(service);
                    }
                    return Activator.CreateInstance(type, parameterInstances.ToArray());
                }
                catch (GoldStoreException)
                {

                }
            }
            throw new GoldStoreException("No constructor  was found that had all the dependencies satisfied.");
        }
