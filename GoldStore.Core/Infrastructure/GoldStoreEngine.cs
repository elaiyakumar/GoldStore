...
namespace GoldStore.Core.Infrastructure
{
    ...
    /// Engine
    /// </summary>
    public class GoldStoreEngine : IEngine
    {
        #region Fields
        ...
        protected virtual void RegisterDependencies(GoldStoreConfig config)
        {
            var builder = new ContainerBuilder();

            //dependencies
            var typeFinder = new WebAppTypeFinder();
            builder.RegisterInstance(config).As<GoldStoreConfig>().SingleInstance();
        ...
        /// </summary>
        /// <param name="config">Config</param>
        protected virtual void RegisterMapperConfiguration(GoldStoreConfig config)
        {
            //dependencies
            var typeFinder = new WebAppTypeFinder();
        ...
        /// </summary>
        /// <param name="config">Config</param>
        public void Initialize(GoldStoreConfig config)
        {
            //register dependencies
